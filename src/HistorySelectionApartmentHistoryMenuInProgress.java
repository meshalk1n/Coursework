...
public class HistorySelectionApartmentHistoryMenuInProgress extends JDialog {
...
public HistorySelectionApartmentHistoryMenuInProgress() {
    png();
    Connect();
    table_load();
    setTitle("");
    ...
    returnButton.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(action == 0) {
                ...
                try {
                    String query = ("delete from kvart_in_progress  where id = '" + textId.getText() + "' ");
    ...
    soldButton.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            int action = JOptionPane.showConfirmDialog(
                    null,"вы уверены?","sold",
                    JOptionPane.YES_NO_OPTION);
            if(action == 0) {
                try {
                    prepareStatement = connection.prepareStatement(
                            "insert into kvart_sold(ulica,nomer_kvart,ploshch_kvart,kol_komnat,tcena)values(?,?,?,?,?)");
                    prepareStatement.setString(1, textUlica.getText());
                    prepareStatement.setString(2, textNomerKvart.getText());
                    prepareStatement.setString(3, textPloshchKvart.getText());
                    prepareStatement.setString(4, textKolKomnat.getText());
    ...
    table1.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
            try {
                ...
                String query = "select * from kvart_in_progress where id = '" + ID_ + " ' ";
                PreparedStatement preparedStatement = connection.prepareStatement(query);
    ...
    textSearch.addKeyListener(new KeyAdapter() {
        ...
        public void keyReleased(KeyEvent e) {
            try {
                ...
                String query =
                        "select id,ulica,nomer_kvart,ploshch_kvart,kol_komnat,tcena from kvart_in_progress where "+selection+" = ?";
                PreparedStatement preparedStatement = connection.prepareStatement(query);
...
void png(){
    ImageIcon imageIcon = new ImageIcon("src/pngHistorySelectionApartmentHistoryMenuInProgress/sold.png");
    label1.setIcon(imageIcon);
    ImageIcon imageIcon1 = new ImageIcon("src/pngHistoryHouseMenuInProgress/back-button.png");
    label2.setIcon(imageIcon1);
    ImageIcon imageIcon2 = new ImageIcon("src/pngHistoryHouseMenuInProgress/refresh.png");
    label3.setIcon(imageIcon2);
    ImageIcon imageIcon3 = new ImageIcon("src/pngHistoryHouseMenuInProgress/back-button.png");
    label4.setIcon(imageIcon3);
    ImageIcon imageIcon4 = new ImageIcon("src/pngHistoryHouseMenuInProgress/search.png");
    ...
    void table_load()
    {
        try
        {
            prepareStatement = connection.prepareStatement("select * from kvart_in_progress");
