...
public class HistoryHouseMenuInProgress extends JDialog  {
    ...
    public HistoryHouseMenuInProgress (){
        png();
        Connect();
        table_load();
        setTitle("");
        ...
        returnButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(action == 0) {
                    ...
                    try {
                        String query = ("delete from dom_in_progress  where id = '" + textId.getText() + "' ");
        ...
        table1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    String query = "select * from dom_in_progress where id = '" + ID_ + " ' ";
                    PreparedStatement preparedStatement = connection.prepareStatement(query);
        ...
        textSearch.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                try {
                    ...
                    String query =
                            "select id,ulica,nomer_dom,ploshch_dom,kol_komnat,tcena from dom_in_progress where "+selection+" = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(query);
        ...
        soldButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(action == 0) {
                    try {
                        prepareStatement = connection.prepareStatement(
                                "insert into dom_sold(ulica,nomer_dom,ploshch_dom,kol_komnat,tcena)values(?,?,?,?,?)");
                        prepareStatement.setString(1, textUlica.getText());
                        prepareStatement.setString(2, textNomerDom.getText());
                        prepareStatement.setString(3, textPloshchDom.getText());
                        prepareStatement.setString(4, textKolKomnat.getText());
    ...
    void table_load()
    {
        try
        {
            prepareStatement = connection.prepareStatement("select * from dom_in_progress");
    ...
    void png()
    {
        ImageIcon imageIcon = new ImageIcon("src/pngHistoryHouseMenuInProgress/refresh.png");
        label1.setIcon(imageIcon);
        ImageIcon imageIcon1 = new ImageIcon("src/pngHistoryHouseMenuInProgress/back-button.png");
        label2.setIcon(imageIcon1);
        ImageIcon imageIcon2 = new ImageIcon("src/pngHistoryHouseMenuInProgress/back-button.png");
        label3.setIcon(imageIcon2);
        ImageIcon imageIcon3 = new ImageIcon("src/pngHistoryHouseMenuInProgress/sold.png");
